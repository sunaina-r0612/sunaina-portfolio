...
const skills = [
  {
    ...
    icons: [<FaHtml5 key="html5" />, <FaCss3 key="css3" />, <FaJs key="js" />, <FaReact key="react" />, <SiNextdotjs key="nextjs" />],
  },
  {
  ...
  },
  {
    ...
    icons: [
      ...
      <SiMicrosoftoffice key="office" />,
      <SiGoogleslides key="slides" />,
      <SiGooglesheets key="sheets" />,
      <SiGoogledocs key="docs" />,
    ],
  },
];
...
const About = () => {
  ...
  const sections = [
    ...
    { title: "credentials", data: credentials },
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex flex-col w-full xl:max-w-[48%] h-[480px]">
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
            {sections.map((section, sectionIndex) => (
              <div
                ...
                className={`${index === sectionIndex && 'text-accent after:w-[100%] after:bg-accent after:transition-all after:duration-300'} cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute after:bottom-1 after:left-0`}
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-Y-2 xl:gap-Y-4 items-center xl:items-start">
            {sections[index].data.map((item, itemIndex) => (
              <div key={`${sections[index].title}-${itemIndex}`}>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-white/60">
                  ...
                  <div className="flex gap-x-4">
                    {item.icons?.map((icon, iconIndex) => (
                      <div className="text-xl" key={`${item.title}-${iconIndex}`}>
                        {icon}
                      </div>
                    ))}
                  </div>
